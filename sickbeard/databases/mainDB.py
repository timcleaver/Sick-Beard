...
class AddSDHD_WEBDL_WEBRIPQualities(AddEmailSubscriptionTable):                                                                                                                                                                                                                                                                                                                          
    """Add support for 1080p related qualities along with RawHD                                                                                                                                                                                                                                                                                                                          
    ...
    def _update_quality(self, old_quality):                                                                                                                                                                                                                                                                                                                                              
        ...
        if(result & (1<<6)):                                                                                                                                                                                                                                                                                                                                                             
            result = result & ~(1<<6)                                                                                                                                                                                                                                                                                                                                                    
            result = result | (1<<10)                                                                                                                                                                                                                                                                                                                                                    
        # move hdwebdl from 1<<5 to 1<<9 if set                                                                                                                                                                                                                                                                                                                                          
        if(result & (1<<5)):                                                                                                                                                                                                                                                                                                                                                             
            result = result & ~(1<<5)                                                                                                                                                                                                                                                                                                                                                    
            result = result | (1<<9)                                                                                                                                                                                                                                                                                                                                                     
        ...
        if(result & (1<<2)):                                                                                                                                                                                                                                                                                                                                                             
            result = result & ~(1<<2)                                                                                                                                                                                                                                                                                                                                                    
            result = result | (1<<4)                                                                                                                                                                                                                                                                                                                                                     
        # move sddvd from 1<<1 to 1<<3 if set                                                                                                                                                                                                                                                                                                                                            
        if(result & (1<<1)):                                                                                                                                                                                                                                                                                                                                                             
            result = result & ~(1<<1)                                                                                                                                                                                                                                                                                                                                                    
            result = result | (1<<3)                                                                                                                                                                                                                                                                                                                                                     
